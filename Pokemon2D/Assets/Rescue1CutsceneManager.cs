...
public class Rescue1CutsceneManager : TRiggerableEvent
{
    public bool functionCalled = false;

    public Fader fader;

    [SerializeField] public GameObject Rescue1Cutscene;
    ...
    void Start()
    {
        ...
        Rescue1Cutscene = cutscenes.cutscenes[0].gameObject;
    ...
    public override IEnumerator PlayCutscene()
    {
        ...
        Rescue1Cutscene.SetActive(true);
        yield return fader.FadeOut(4f);
        yield return fader.FadeIn(2f);
        //yield return new WaitForSeconds(8f);
        Rescue1Cutscene.SetActive(false);
