...
public class FishStatue3Manager : TRiggerableEvent
{
    ...
    void Start()
    {
        ...
        statue3man = FindObjectOfType<Statue3Manager>();
        ...
        statue = rebuiltStatus.transform.GetChild(2).gameObject;

        cutscene = FindObjectOfType<cutsceneManagerr>();

        triggerCutscene = cutscene.cutscenes[37].gameObject;

        emptystatue = rebuiltStatus.transform.GetChild(0).gameObject;

        pieces = statue3man.transform.GetChild(1).gameObject;
