...
public class Rescue3Cutescene : TRiggerableEvent
{
    public bool functionCalled = false;

    public Fader fader;

    [SerializeField] public GameObject Rescue3Cutscene;
    ...
    void Start()
    {
        ...
        Rescue3Cutscene = cutscenes.cutscenes[2].gameObject;
    ...
    public override IEnumerator PlayCutscene()
    {
        ...
        Rescue3Cutscene.SetActive(true);
        yield return fader.FadeOut(4f);
        yield return fader.FadeIn(2f);
        //yield return new WaitForSeconds(8f);
        Rescue3Cutscene.SetActive(false);
