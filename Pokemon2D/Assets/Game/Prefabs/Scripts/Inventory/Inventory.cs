...
public enum ItemCatagory { Items, Capsules, Tms, Pms}
public class Inventory : MonoBehaviour, ISavable
{
    ...
    public void RemoveItem(ItemBase item, int countToRemove = 1)
    {
        ...
        var itemSlot = currSlots.FirstOrDefault(slots => slots.Item == item);
    ...
    {
  // Wont need unless want to catogorize items, causes error when capsule is selected
