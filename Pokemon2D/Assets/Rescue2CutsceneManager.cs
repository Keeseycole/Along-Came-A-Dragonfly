...
public class Rescue2CutsceneManager : TRiggerableEvent
{
    public bool functionCalled = false;

    public Fader fader;

    [SerializeField] public GameObject Rescue2Cutscene;
    ...
    void Start()
    {
        ...
        Rescue2Cutscene = cutscenes.cutscenes[1].gameObject;
    ...
    public override IEnumerator PlayCutscene()
    {
        ...
        Rescue2Cutscene.SetActive(true);
        yield return fader.FadeOut(4f);
        yield return fader.FadeIn(2f);
        //yield return new WaitForSeconds(8f);
        Rescue2Cutscene.SetActive(false);
